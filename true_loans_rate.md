...
第 2 个月，张三上个月还了 2000 元，占用了银行 (48万 - 2千)贷款，利息为：(50万 - 2千) x 0.4% = 1912 元 <br/>
第 3 个月，张三上个月还了 2000 元，总共还了 4000，占用了银行 (48万 - 2千 - 2千)贷款，利息为：(50万 - 2千 - 2千) x 0.4% = 1902 元 <br/>
...<br/>
第 240 个月，张三总共还了 478000，占用银行 2千贷款，利息为：2千 x 0.4% = 8 元<br/>

总共还的利息为：1920 + 1912 + 1908 + ... + 16 + 8，这是个等差数列，根据等差数列的特性，求平均值：(1920 + 8) / 2 = 964，平均值 x 总期数 = **总利息（贷款的代价）：964 x 240 = 231360 元**，可以看出远小于 46.08万元的利息。
...
答：并不是，银行收取多少利息是根据你每月占用贷款数额的大小，等额本金方式由于每个月还的本金多，占用的贷款金额会越来越少，所以利息相对较少，相比之下等额本息方式相当于每月占用的贷款金额较多，所以利息较多，带来的好处是每月还款金额固定，好安排其他生活支出。
...
14.6% 远大于银行基准利率 4.35%，借贷 10000，**利息（贷款的代价）为：10000 * 14.6% = 1460**。
